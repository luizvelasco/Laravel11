                    ...
                    @forelse ($users as $user)
                        <tr>
                            ...
                            <td class="d-md-flex flex-row justify-content-center">
                                <a href="{{ route('user.show', ['user' => $user->id ])}}" class="btn btn-primary btn-sm me-1 mt-1 mt-md-0"><i class="fa-regular fa-eye"></i> Visualizar</a>
                                <a href="{{ route('user.edit', ['user' => $user->id ])}}" class="btn btn-warning btn-sm me-1 mt-1 mt-md-0"><i class="fa-regular fa-pen-to-square"></i> Editar</a>
