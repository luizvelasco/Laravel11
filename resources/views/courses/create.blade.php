        ...
        <div class="card-body">
            ...
            <form class="row g-3" action="{{ route('course.store')}}" method="POST">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name = "name" class="form-control" id="name"  placeholder="Nome do curso" value="{{old('name')}}"  >
                </div>
                <div class="col-12">
                    <label for="price" class="form-label">Preço</label>
                    <input type="text" name = "price" class="form-control" id="price"  placeholder="Preço do curso: 2.47" value="{{old('price')}}"  >
                </div>
                <div class="col-12">
